...
export default function CartaoProduto(props: CartaoProdutoProps) {
    ...
    return (
        <div className="flex flex-col w-72 bg-zinc-900 max-w-xs transition duration-300 ease-in-out hover:scale-105 rounded-lg
            ...
            <div className="flex-1 flex flex-col gap-4 p-5">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button
                        ...
                        className="border rounded-lg px-5 py-1 text-sm"
                    >
                        Adicionar
                    </button>
                </div>
